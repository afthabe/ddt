 ...
 * 
 * OutputStream out = new Base64.OutputStream(                   new FileOutputStream( "out.txt" ) );
 * // Go on about your outputting...
 * // ...
 * 
 * InputStream in = new Base64.InputStream( new FileInputStream( "in.txt" ) );
 * // Go on about your inputting...
 * // ...
 * 
 * There are defaults (OutputStream encodes, InputStream decodes), but you can easily override that:
 * 
 * OutputStream out = new Base64.OutputStream( new FileOutputStream( "out.txt" ), Base64.DECODE );
 * // Go on
 * 
 * @since 1.0
 *
